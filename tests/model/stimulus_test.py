...
def get_stimulus_parameters():
    ...
    return audio, prompt, primer, options, time_stamps


def stimulus_checks(stimulus, audio, prompt, primer, options, time_stamps):
...
def test_created_stimulus_valid_call():
    ...
    created_stimulus = CreatedStimulus(audio, prompt, primer, options, time_stamps, modified_audio)
