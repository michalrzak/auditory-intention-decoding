...
from auditory_stimulation.auditory_tagging.shift_tagger import ShiftSumTaggerFactory, SpectrumShiftTaggerFactory
...
def test_audio_taggers_create_valid_call_audio_should_be_modified_to_half_point(audio_tagger_factory):
    ...
    tagger = audio_tagger_factory.create_audio_tagger(audio, stimuli_intervals)
